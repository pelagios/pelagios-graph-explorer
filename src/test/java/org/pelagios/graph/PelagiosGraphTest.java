...
import org.pelagios.bootstrap.Setup;
...
/**
 * A few basic unit tests for the PelagiosGraph implementation.
 * 
...
public class PelagiosGraphTest {
    ...
    public void testAddDatasets() throws DatasetExistsException, DatasetNotFoundException {
        ...
        for (Dataset subset : subsets) {
            ...
            Assert.assertTrue(subset.getParentDataset().getName().equals("gap"));
    ...
    public void testAddPlace() throws URISyntaxException, PlaceExistsException, PlaceNotFoundException {
        ...
        PlaceBuilder corsica = new PlaceBuilder("Corsica", new URI("http://pleiades.stoa.org/places/991339"),
                new GeoJSONParser()
                        .parse("{ \"type\": \"Point\", \"coordinates\":[26.108246000000001,35.208534999999998] }"));
