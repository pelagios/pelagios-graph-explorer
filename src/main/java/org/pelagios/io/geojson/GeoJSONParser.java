...
/**
 * A GeoJSON parser. Warning: handles ONLY Point, LineString and
...
public class GeoJSONParser {
    ...
    public Geometry parse(JsonObject json) {
        GeometryType type = GeometryType.valueOf(json.get(TYPE).getAsString().toUpperCase());
    ...
    private Polygon parsePolygon(JsonElement coordinates) {
        ...
        LinearRing shell = geomFactory.createLinearRing(parseLineString(linestrings.get(0)).getCoordinates());
